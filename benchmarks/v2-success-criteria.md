...
- `v2.0.0-rc.4`: each V1 baseline claim is backed by content-addressed source blobs from the exact freeze Commit; formal-efficiency eligibility requires metrics evidence for its denominator.
