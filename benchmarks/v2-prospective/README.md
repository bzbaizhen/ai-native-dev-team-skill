...
The command rejects merge history, receipt edits/deletes, non-continuous registration, a self-rehashed replacement registry, unanchored `task_ready`, invented or digest-mismatched V1 baselines, missing or digest-mismatched baseline source blobs, incomplete claim coverage, unsupported denominator claims, source-level hard-gate violations in the candidate window, and a candidate Commit that never reached the stable Commit. It proves frozen-content integrity, not the truth or qualification of the historical sources. It also cannot prove that a local ref was remotely protected or when it was pushed; the trusted freeze/head pair must come from an independent control. It does not prove efficiency improvement. Formal claims still require 15–20 accepted tasks whose frozen V1 baselines explicitly have reconstructable denominators, plus human source qualification and the preregistered stratified comparison.
